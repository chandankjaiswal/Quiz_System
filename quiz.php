...
<br> <h1 class="text-center text-primary">Welcome to E-Commerce Test</h1>
...
<h3 class="text-center card-header"> Welcome <?php echo $_SESSION['username']; ?>,(You have to selected out of 6.Best Of Luck:)</h3>
